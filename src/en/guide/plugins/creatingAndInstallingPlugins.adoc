...
These files will be included in the plugin package while the `application.yml` file is used when the plugin is run as an application. See <<excludedArtefacts>>.
